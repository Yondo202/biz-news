...
const advancedMatching = { em: 'yondooo61@gmail.com' }; // optional, more info: https://developers.facebook.com/docs/facebook-pixel/advanced/advanced-matching
const options = {
  autoConfig: true, // set pixel's autoConfig
  debug: false, // enable logs
};
ReactPixel.init('467948500805836', advancedMatching, options);

ReactPixel.pageView('nana'); // For tracking page view
ReactPixel.track(event, data); // For tracking default events, more info about events and data https://developers.facebook.com/docs/ads-for-websites/pixel-events/v2.9
ReactPixel.trackSingle('467948500805836', event, data); // For tracking default events, more info about events and data https://developers.facebook.com/docs/ads-for-websites/pixel-events/v2.9
ReactPixel.trackCustom(event, data); // For tracking custom events
ReactPixel.trackSingleCustom('467948500805836', event, data); // For tracking custom events
...
export default function Home(props) {
    ...
    useEffect(() => {
       ...
       ReactPixel.default.init('467948500805836');
    }, [])
