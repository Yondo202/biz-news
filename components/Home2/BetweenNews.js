...
export class BetweenNews extends Component {
    ...
    render() {
        ...
        return (
            <Container fluid style={{width:'70%'}} className="betweenNewsPar">
                <Row>
                    <Col Col md={4} >
                        <div style={{ marginBottom: 40 }}>
                            <div className="TopSmall">
                                <img src={`${Brandfilter[0].image.url}`} alt="myImage" />
                    ...
                    <Col Col md={4} >
                        <div style={{ marginBottom: 40 }}>
                            <div className="TopSmall">
                                <img src={`${Businessfilter[0].image.url}`} alt="myImage" />
                                <div className="background"></div>
                                <div className="content">
                                    <div className="catigory">
                    ...
                    <Col Col md={4} >
                        <div style={{ marginBottom: 40 }}>
                            <div className="TopSmall">
                                <img src={`${Startup[0].image.url}`}  alt="myImage" />
                                <div className="background"></div>
                                <div className="content">
                                    <div className="catigory">
